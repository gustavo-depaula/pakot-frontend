		...
		<div class="modal-content">
			<div class="box">
				...
				<div v-if="isDeliveryMan">
					...
					<button v-if="state == 1" @click="$emit('arrived')" class="actionBtn button is-primary is-medium"><span class="icon"><i class="fa fa-truck"></i></span>&nbsp;&nbsp;{{btnMessage}}</button>
					<button v-if="state == 2" @click="$emit('dispatch')" class="actionBtn button is-info is-medium"><span class="icon"><i class="fa fa-road"></i></span>&nbsp;&nbsp;{{btnMessage}}</button>
				...
				<button v-if="!isDeliveryMan && (dispatched == 'false' || !dispatched)" @click="$emit('cancel')" class="actionBtn button is-danger is-medium"><span class="icon"><i class="fa fa-times"></i></span>&nbsp;&nbsp;Cancelar esta entrega.</button>
			</div>
		</div>
